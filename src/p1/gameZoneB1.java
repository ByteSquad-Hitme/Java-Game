...
//    static mainMenuHandler mHandler = new  mainMenuHandler();
    ...
    private static int Max_MISSES = 5;
...
//		frame.add(gamePanel);        
    ...
    public gameZoneB1(JFrame baseframe) {
    	  
    	
    	//Setting up the Color
    	Color baseframeColor = null;
    	baseframeColor.getColor(getName(), baseframe.getContentPane().getBackground());
...
//				new gameZoneB1copy1(baseframe);
    	...
    	mainMenuButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//linking up MenuPage
				MenuPage.menutitle.setVisible(true);
				MenuPage.startButton.setVisible(true);
				MenuPage.scoreButton.setVisible(true);
				MenuPage.settButton.setVisible(true);
				MenuPage.homeButton.setVisible(true);
			}
