...
public class gameZoneB1copy1 extends JPanel{
	//helper
//	static JFrame frame;
...
//    static mainMenuHandler mHandler = new  mainMenuHandler();
   ...
   //The Components
    ...
    private static final StartStopTimer phone1 = new StartStopTimer();
    ...
    private static JButton retryButton,nextButton, mainMenuButton;
...
//		frame.add(gamePanel);        
    ...
    public gameZoneB1copy1(JFrame baseframe) {
		...
		Image img1 = new ImageIcon( gameZoneB1.class.getResource("/Images/pause.png")).getImage(); // removed that .getClass part from the previous buttons
		...
		phone1.timedisplayer.setForeground(Color.yellow);
		phone1.timedisplayer.setOpaque(true);
		phone1.timedisplayer.setBackground(Color.black);
		phone1.timedisplayer.setBounds(20,10,300,40);
		phone1.timedisplayer.setFont(pixelMplus);
		phone1.timedisplayer.setFont(phone1.timedisplayer.getFont().deriveFont(Font.BOLD, 22f));
		dashPanel.add(phone1.timedisplayer);
		phone1.startRinging();
		
		//Setting up pop buttons
    	//Retry button
		retryButton =  new JButton("RETRY");
		retryButton.setBounds(140,110,120,40);
...
//    	retryButton.setBorderPainted(false);
		...
		retryButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				popupframe.dispose();
				phone1.timedisplayer.setVisible(false);
...
//    	nextButton.setBorderPainted(false);
    ...
    public class gamethread extends Thread{
		...
		protected void paintComponent(Graphics g) {
            ...
            if((phone1.min == 0 && phone1.sec == 0) || hitCount == HIT_TARGET ||   (Max_MISSES - missCount  == 0) ) {
            	phone1.timedisplayer.setText("Time Remaining : " +phone1.min + ":" + phone1.sec);
            	phone1.timer.cancel();
            	flag1 =false;
            	flag4 = false;
//            	baseframe.setEnabled(false);
            	//The popups
                if((phone1.min == 0 && phone1.sec == 0) ||  (Max_MISSES - missCount  == 0) ) {
            	incompletePopup();
                }
                else {
                levelCompletePopup();
        ...
        public static class pauseResumeHandler implements ActionListener{
    		...
    		@Override
    		public void actionPerformed(ActionEvent e) {
    			Image img2 = new ImageIcon(gameZoneB1.class.getResource("/Images/play.png")).getImage();  // removed that .getClass part from the previous buttons
